...
class Workout {
  ...
  // just to check the number of clicks on a particular workout
  clicks = 0;
...
class App {
  ...
  _moveToPopup(e) {
    ...
    //when data is inherited from local storage it is inherited as a normal object, it loses its prototye chain.
    // workout.click();
  }
  _setLocalStorage() {
